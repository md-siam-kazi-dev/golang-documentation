---
title: "sort"
description: "Learn about sort in Go."
order: 12
...
sort fits into everyday Go development. Below is an outline of the key ideas and a small, runnable example.

## Key Concepts

- Understand the core idea behind sort.
...
- Practice by applying sort to a small project.
