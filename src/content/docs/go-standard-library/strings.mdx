---
title: "strings"
description: "Learn about strings in Go."
order: 2
...
strings fits into everyday Go development. Below is an outline of the key ideas and a small, runnable example.

## Key Concepts

- Understand the core idea behind strings.
...
func main() {
	fmt.Println("Hello from strings")
}
```
...
- Practice by applying strings to a small project.
