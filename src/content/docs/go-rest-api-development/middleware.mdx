---
title: "Middleware"
description: "Learn about middleware in Go."
order: 8
...
Middleware fits into everyday Go development. Below is an outline of the key ideas and a small, runnable example.

## Key Concepts

- Understand the core idea behind middleware.
...
- Practice by applying middleware to a small project.
