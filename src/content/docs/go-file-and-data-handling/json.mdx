---
title: "JSON"
description: "Learn about json in Go."
order: 6
...
JSON fits into everyday Go development. Below is an outline of the key ideas and a small, runnable example.

## Key Concepts

- Understand the core idea behind json.
...
- Practice by applying json to a small project.
