---
title: "RPC"
description: "Learn about rpc in Go."
order: 2
...
RPC fits into everyday Go development. Below is an outline of the key ideas and a small, runnable example.

## Key Concepts

- Understand the core idea behind rpc.
...
- Practice by applying rpc to a small project.
