---
title: "encoding/json"
description: "Learn about encoding/json in Go."
order: 10
...
encoding/json fits into everyday Go development. Below is an outline of the key ideas and a small, runnable example.

## Key Concepts

- Understand the core idea behind encoding/json.
...
func main() {
	fmt.Println("Hello from encoding/json")
}
```
...
- Practice by applying encoding/json to a small project.
